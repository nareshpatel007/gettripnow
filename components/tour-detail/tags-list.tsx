        ...
        <div className="py-8">
            ...
            <div className="flex flex-wrap gap-3">
                {items.map((item: any, index: number) => (
                    <Link key={index} href={`/${slug}/${item?.slug}`} className="inline-flex items-center border border-[#1a2b49] hover:bg-[#2a3b59] hover:text-white transition-colors rounded overflow-hidden">
