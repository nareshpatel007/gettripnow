...
const questions = [
  ...
  "What are the best attractions in the Cayman Islands?",
  "What are the best day trips from the Cayman Islands?",
  "What are the best affordable things to do in the Cayman Islands?",
  "What are the best outdoor activities in the Cayman Islands?",
  "What are the best museums and exhibitions in the Cayman Islands?",
  "What are the best activities for couples in the Cayman Islands?",
]
...
export function PeopleAlsoAsk() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
      <h2 className="text-xl font-bold text-gray-900 mb-6">People Also Ask</h2>
