  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 md:py-8 flex items-center justify-center gap-1 md:gap-2">
      <button
        ...
        className="p-1.5 md:p-2 rounded-full border border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
      >
      ...
      {[1, 2, 3].map((page) => (
        <button
          ...
          className={`w-8 h-8 md:w-10 md:h-10 rounded-full text-xs md:text-sm font-medium transition-colors ${
            currentPage === page ? "bg-[#0057A8] text-white" : "border border-gray-300 text-gray-700 hover:bg-gray-50"
          }`}
        >
          {page}
        </button>
