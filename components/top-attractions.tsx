    ...
    return (
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-[#1a2b49]">Top Attractions in Cayman Islands</h2>
                <div className="flex items-center gap-2">
                    <button
                        onClick={slideLeft}
                        disabled={!canSlideLeft}
                        className={`p-2 rounded-full border border-gray-300 transition-colors ${canSlideLeft ? "hover:bg-gray-50" : "opacity-50 cursor-not-allowed"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`p-2 rounded-full border border-gray-300 transition-colors ${canSlideRight ? "hover:bg-gray-50" : "opacity-50 cursor-not-allowed"
                            }`}
                    >
            ...
            <div className="flex justify-center gap-2 mt-4 md:hidden">
                {Array.from({ length: totalSlides }).map((_, index) => (
                    <button
                        ...
                        className={`w-2 h-2 rounded-full transition-colors ${currentSlide === index + 1 ? "bg-[#1a9cb0]" : "bg-gray-300"
                            }`}
                    />
                ))}
            </div>
